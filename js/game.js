...
const HolidayEngine = {
    holidays: [
        { id: 'may_1', name: '��T��-���+�-���� �-��T��-T�', date: '2026-05-01', reward: 500 },
        { id: 'may_9', name: '�Ԧ��-T� �ߦ-�-���+T�', date: '2026-05-09', reward: 1000 }
    ],
    check() {
        const now = new Date();
        ...
        this.holidays.forEach(h => {
            ...
            if (diffDays <= 7 && diffDays > 0) {
                ...
                hubBonus.innerHTML = T�T����T� \ \ \ \;
            } else if (diffDays === 0) {
                hubBonus.classList.remove('hidden');
                hubBonus.innerHTML = T�T������� \! \;
    ...
    claim(h) {
        ...
        if (claimed.includes(h.id)) return alert(state.lang === 'ru' ? '�㦦�� ���-��T�TǦ��-�-!' : 'Already claimed!');
