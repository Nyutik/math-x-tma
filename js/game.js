...
const HolidayEngine = {
    holidays: [
        { id: 'may_1', name: '��T��-���+�-���� �-��T��-T�', date: '2026-05-01', reward: 1000, art_id: 101 },
        { id: 'may_9', name: '�Ԧ��-T� �ߦ-�-���+T�', date: '2026-05-09', reward: 2000, art_id: 102 }
    ],
    check() {
        const now = new Date();
        ...
        this.holidays.forEach(h => {
            ...
            if (diffDays <= 7 && diffDays > 0) {
                ...
                hubBonus.innerHTML = '��- ' + h.name + ' ' + (state.lang === 'ru' ? 'TǦ�T�����' : 'in') + ' ' + diffDays + ' ' + (state.lang === 'ru' ? '�+�-.' : 'd.');
                hubBonus.onclick = null;
            } else if (diffDays === 0) {
                activeHoliday = h;
                hubBonus.classList.remove('hidden');
                hubBonus.style.background = 'linear-gradient(90deg, #8b5cf6, #d946ef)';
                hubBonus.innerHTML = 'T�T������� ' + h.name + '! ' + (state.lang === 'ru' ? '�ئӦ�Ц�� ��ަҦ��ئ�' : 'PLAY EVENT');
    ...
    startEvent(h) {
        ...
        if (completed.includes(h.id)) {
            alert(state.lang === 'ru' ? '��-�-T�T¦��� Tæ�� ��T��-��+���-�-!' : 'Event already completed!');
            return;
        }
    ...
    completeEvent() {
        ...
        updateUI();
        alert('T�T������� ' + h.name + ' ' + (state.lang === 'ru' ? '�ߦ�ަ��զݦ�!' : 'COMPLETED!') + ' +' + h.reward + ' T�Tߦ����');
